...
SID <string>  
Specifies the Active Directory account security identifier for the machine on which the service instance is running.## Notes If the command fails, the following errors can be returned.  
错误代码  
\---\---\-----  
UnknownObject  
未找到其中一个指定的对象。  
