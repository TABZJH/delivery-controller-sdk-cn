...
The SQL scripts to perform schema upgrades and downgrades can be obtained using the Get-ConfigDBVersionChangeScript cmdlet. Citrix 建议尽可能使用 Studio 执行服务架构升级，而不是手动通过 SDK 升级。
